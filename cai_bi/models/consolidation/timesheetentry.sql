...
salesforce as (
    select
        ...
        sf_project.id as key_project,
        md5(sf_project.id) as hash_key_project,
        cast(sf_project_task.id as string) as key_task,
        md5(sf_project_task.id) as hash_key_task,
        -- concat(sf_project.intacct_project_id_c, sf_contact.pse_api_resource_correlation_id_c, sf_project_task.intacct_id_c, sf_timesheetentry.entrydate) as key_timesheet_entry,
        -- md5(concat(sf_project.intacct_project_id_c, sf_contact.pse_api_resource_correlation_id_c, sf_project_task.intacct_id_c, sf_timesheetentry.entrydate)) as hash_key_timesheet_entry,
