...
select 
    ...
    cast(inv.totalretained as number(38,0)) as qty_total_retained,
    cast(inv.totalselected as number(38,0)) as qty_total_selected,
    cast(inv.trx_entitydue as number(38,17)) as amt_trx_entity_due,
    cast(inv.trx_totaldiscountapplied as number(38,0)) as qty_trx_total_discount_applied,
    ...
    cast(inv.trx_totalreleased as number(38,0)) as qty_trx_total_released,
    cast(inv.trx_totalretained as number(38,0)) as qty_trx_total_retained,
    cast(inv.trx_totalselected as number(38,0)) as qty_trx_total_selected,
