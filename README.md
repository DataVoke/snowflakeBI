...
4. Set up your dbt connection profile in `~/.dbt/profiles.yml` with your Snowflake account details (see the example configuration below)
5. Run the dbt commands to build and test your models (NOTE: Make sure to run these commands from the root directory of the **project** where the `dbt_project.yml` file is located)
6. (Optional) Deactivate the virtual environment when you're done:
