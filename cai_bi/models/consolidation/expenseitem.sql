...
salesforce as (
    ...
    left join sf_expensereport on sf_expensereport.pse_project_c = sf_project.id
),
...
select
    ...
    expense_type_detail_c as expense_type_detail_c,
    ...
    projectname,
    psa_url,
    pse_assignment_c as pse_assignment,
    pse_audit_notes_c as pse_audit_notes,
    pse_lost_receipt_c as pse_lost_receipt,
    pse_notes_c as pse_notes,
    pse_rate_unit_c as pse_rate_unit,
    cast(pse_reimbursement_amount_in_project_currency_c as number(38, 2)) as pse_reimbursement_amount_in_project_currency,
    pse_reimbursement_currency_c as pse_reimbursement_currency,
    pse_type_c as pse_type,
