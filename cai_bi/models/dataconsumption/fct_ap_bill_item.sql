...
final as (
    select 
        ...
        ab.module_key ap_module_key,
        ab.payto_tax_id ap_payto_tax_id,
        ab.pr_batch_key ap_pr_batch_key,
        ab.schop_key ap_schop_key,
        ab.ship_to_return_to_key ap_ship_to_return_to_key,
        ab.supdoc_id ap_supdoc_id,
        ab.tax_solution_id ap_tax_solution_id,
        ab.term_key ap_term_key,
        ab.user_id ap_user_id,
        ab.amt_total_due ap_amt_total_due,
        ab.amt_total_entered ap_amt_total_entered,
        ab.amt_trx_total_entered ap_amt_trx_total_entered,
        ab.base_currency_code ap_base_currency_code,
        ab.bill_back_template ap_bill_back_template,
        ab.billto_payto_contact_name ap_billto_payto_contact_name,
        ab.bln_do_not_process_vat ap_bln_do_not_process_vat,
        ab.bln_on_hold ap_bln_on_hold,
        ab.bln_retain_age_released ap_bln_retain_age_released,
        ab.bln_system_generated ap_bln_system_generated,
        ab.contact_tax_group ap_contact_tax_group,
        ab.description ap_description,
        ab.description_2 ap_description_2,
        ab.doc_number ap_doc_number,
        ab.dte_rec_payment ap_dte_rec_payment,
        ab.dte_when_discount ap_dte_when_discount,
        ab.dte_when_due ap_dte_when_due,
        ab.dte_when_paid ap_dte_when_paid,
        ab.dte_when_posted ap_dte_when_posted,
        ab.dts_au_src_created ap_dts_au_src_created,
        ab.due_in_days ap_due_in_days,
        ab.financial_entity ap_financial_entity,
        ab.megaentity_name ap_megaentity_name,
        ab.payment_priority ap_payment_priority,
        ab.payto_taxgroup_name ap_payto_taxgroup_name,
        ab.payto_taxgroup_recordno ap_payto_taxgroup_recordno,
        ab.pr_batch ap_pr_batch,
        ab.raw_state ap_raw_state,
        ab.sender_email ap_sender_email,
        ab.shipto_returnto_contact_name ap_shipto_returnto_contact_name,
        ab.tax_entity_number ap_tax_entity_number,
        ab.tax_reverse_status ap_tax_reverse_status,
        ab.term_name ap_term_name,
        ab.term_value ap_term_value,
