...
sage_intacct as (
    select 
        ...
        true as bln_current,
        cast(si_project.recordno as string) as key,
        md5(si_project.recordno) as hash_key,
        cast(si_project.recordno as string) as link,
        md5(si_project.recordno) as hash_link,
        ifnull(si_location.parentkey, si_location.recordno) as key_entity,
        md5(ifnull(si_location.parentkey, si_location.recordno)) as hash_key_entity,
        null as account_id,
        null as assistant_project_manager_id,
        null as project_accountant_id,
        billtokey as billto_key,
        si_project.parentid as client_site_id,
        null as client_manager_id,
        null as client_manager_name,
        null as client_manager_email,
        si_project.contactkey as contact_key,
        si_project.customerid as customer_id,
        si_project.customerkey as customer_key,
        si_project.departmentid as department_id,
        null as estimate_id,
        null as group_id,
        cast(si_project.locationid as string) as location_id,
        cast(si_project.locationid as string) as location_id_intacct,
        managerkey as manager_key,
        ifnull(nullif(si_location.parentid, ''), si_project.locationid) as entity_id,
        null as opportunity_id,
        null as owner_id,
        si_project.parentkey as parent_key,
        ...
        si_project.shiptokey as ship_to_key,
        cast(si_project.createdby as string) as src_created_by_id,
        cast(si_project.modifiedby as string) as src_modified_by_id,
        ...
        coalesce(billto_contactname, si_project.shipto_contactname) as contact_name,
        null as contract_type,
        null as cost_expense,
        null as cost_total_awarded,
        si_project.currency as currency_iso_code,
        si_project.customername as customer_name,
        si_project.departmentname as department_name,
        si_project.enddate as dte_src_end,
        si_project.begindate as dte_src_start,
        ...
        si_project.whencreated as dts_src_created,
        si_project.whenmodified as dts_src_modified,
        null as group_name,
        invoicecurrency as invoice_currency,
        null as last_resource_plan_review_by,
        null as last_synced_status,
        si_project.locationname as location_name,
        project_memo as memo,
        si_project.parentname as parent_name,
...
salesforce as (
    select
        ...
        null as assistant_project_manager_id,
        project_accountant_c as project_accountant_id,
        null as billto_key,
        ...
        sf_contact.email as client_manager_email,
        null as contact_key,
        null as customer_id,
...
psatools as (
    select 
        ...
        project_accountant_id as project_accountant_id,
        null as billto_key,
