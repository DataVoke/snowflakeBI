...
ukg as (
    select 
        ...
        ukg_employment.id as key_employment,
        md5(ukg_employment.id) as hash_key_employment,
        null as account_id,
        null as azure_id,
        null as contact_id,
...
portal as (
    select
        ...
        null as key_employment,
        null as hash_key_employment,
        null as account_id,
...
sage_intacct as (
    select 
        ...
        concat(si_location.parentkey, si_employee.locationkey) as key_entity,
        md5(concat(si_location.parentkey, si_employee.locationkey)) as hash_key_entity,
...
select
    ...
    gender_id,
    intacct_contact_key,
    intacct_department_key,
    intacct_location_key,
    intacct_employee_id,
    intacct_employee_key,
    ...
    address_state,
    address_street,
    cast(annual_salary as number(19, 4)) as annual_salary,
    bln_exclude_from_resource_planner,
    bln_is_active,
    bln_is_hourly,
    bln_mst,
    bln_pm_qualified,
    ...
    first_name_display,
    former_name,
    cast(historical_utilization_target_hours as number(19, 4)) as historical_utilization_target_hours,
    home_phone,
    home_phone_country,
    cast(hourly_pay_rate as number(19, 4)) as hourly_pay_rate,
    intacct_contact_name,
    job_salary_grade,
    job_title,
    last_name,
    middle_name,
    ...
    cast(other_rate_3 as number(19, 4)) as other_rate_3,
    ...
    cast(total_ann_salary as number(19, 4)) as total_ann_salary,
    ukg_employee_number,
    ukg_override_job_title,
    ukg_status,
