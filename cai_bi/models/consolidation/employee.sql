...
ukg as (
    select 
        ...
        ukg_employment.full_time_or_part_time_code as dol_satus_id,
        ...
        concat(ukg_employee.preferred_name, ' ', ukg_employee.first_name) as display_name,
