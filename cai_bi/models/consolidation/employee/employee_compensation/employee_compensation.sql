...
select 
    ...
    true as bln_current,
    concat(compensation.employee_id,':',company.code) as key,
    md5(concat(compensation.employee_id,':',company.code)) as hash_key,
    concat(compensation.employee_id,':',company.code) as link,
    md5(concat(compensation.employee_id,':',company.code)) as hash_link,
    compensation._fivetran_id as key_fivetran_id,
    md5(compensation._fivetran_id) as hash_key_fivetran_id,
    compensation.company_id as key_entity,
    md5(compensation.company_id) as hash_key_entity,
