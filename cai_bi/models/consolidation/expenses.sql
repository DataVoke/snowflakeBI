...
select
    ...
    dts_src_created,
    dts_src_modified,
    cast(dts_when_paid as timestamp_tz) as dts_when_paid,
    cast(dts_when_posted as timestamp_tz) as dts_when_posted,
    cast(dts_when_submitted as timestamp_tz) as dts_when_submitted,
    currency,
    description,
    employee_name,
    first_name,
