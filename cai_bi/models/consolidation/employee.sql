...
ukg as (
    select 
        ...
        mst.field_value as bln_mst,
        pm_qualified.field_value as bln_pm_qualified,
...
sage_intacct as (
    select 
        ...
        cast (ifnull(si_location.parentkey, si_employee.locationkey) as string )as key_entity,
