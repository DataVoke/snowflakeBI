...
select 
    ...
    entities_intacct_ref.record_id as key_entity_current,
    ...
    cast(ifnull(cc_to_entity_current.fx_rate_mul, 1) as number(38,10)) as conversion_rate_entity_current, -- Should only be null if the conversion currencies match
    ...
    cast(ifnull(annual_salary_original * conversion_rate_entity_current, 0) as number(38,2)) as annual_salary_entity_current,
    ...
    cast(ifnull(annual_salary_entity_current * (1+cola_percent), 0) as number(38,2)) as annual_salary_cola_entity_current,
    ...
    upper(entities_intacct_ref.currency_id) as currency_code_entity_current,
    ...
    entities_intacct_ref.display_name as entity_name_current,
    ...
    cast(hourly_pay_rate_original * conversion_rate_entity_current as number(38,2)) as hourly_pay_rate_entity_current,
    ...
    cast(hourly_pay_rate_entity_current * (1+cola_percent) as number(38,2)) as hourly_pay_rate_cola_entity_current,
    ...
    cast(ifnull(other_rate_1_original * conversion_rate_entity_current, 0) as number(38,2)) as other_rate_1_entity_current,
    ...
    cast(other_rate_3_original * conversion_rate_entity_current as number(38,2)) as other_rate_3_entity_current,
    ...
    cast(other_rate_4_original * conversion_rate_entity_current as number(38,2)) as other_rate_4_entity_current,
    ...
    cast(annual_salary_entity_current * other_rate_2_original as number(38,2)) as performance_bonus_entity_current,
    ...
    cast(period_pay_rate_original * conversion_rate_entity_current as number(38,2)) as period_pay_rate_entity_current,
    ...
    cast(period_pay_rate_entity_current * (1+cola_percent) as number(38,2)) as period_pay_rate_cola_entity_current,
    ...
    cast(weekly_pay_rate_original * conversion_rate_entity_current as number(38,2)) as weekly_pay_rate_entity_current,
    ...
    cast(weekly_pay_rate_entity_current * (1+cola_percent) as number(38,2)) as weekly_pay_rate_cola_entity_current,
    ...
    cast(annual_salary_cola_entity_current + performance_bonus_entity_current + other_rate_1_entity_current as number(38,2)) as total_potential_compensation_entity_current,
    ...
    cast(annual_salary_cola_entity_current + other_rate_1_entity_current as number(38,2)) as total_compensation_entity_current,
...
left join currency_conversion as cc_to_entity_current on (
                                                cc_to_entity_current.frm_curr = upper(currency_code_original)
                                                and cc_to_entity_current.to_curr = upper(currency_code_entity_current) 
                                                and cc_to_entity_current.date = case 
                                                        when job_history.dte_job_effective >= current_date() then current_date()
                                                        when job_history.dte_job_effective <= '2016-01-02' then '2016-01-02'
                                                        else job_history.dte_job_effective 
                                                    end
