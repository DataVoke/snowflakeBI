...
select 
    ...
    '{{ this.name }}' as updated_by,
                    ...
                    job_history.currency_code as currency_code_original,
                    coalesce(entities_ukg_location.currency_id, entities_intacct_ref.currency_id, entities_company.currency_id) as currency_code_entity,
