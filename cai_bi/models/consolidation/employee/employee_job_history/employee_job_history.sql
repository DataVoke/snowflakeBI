...
select 
    ...
    job_history.organization_level_4_id as key_ukg_location,
    md5(job_history.organization_level_4_id) as hash_key_ukg_location,
    ...
    job_history.annual_salary as annual_salary,
    job_history.date_time_created as dts_src_created,
    job_history.flsa_category as flsa_category_id,
    job_history.full_time_or_part_time as bln_is_full_time,
    job_history.hourly_pay_rate as hourly_pay_rate,
    job_history.integration_effective_date as dte_integration_effective,
    ...
    job_history.job_effective_date as dte_job_effective,
    job_history.job_title as job_title,
    job_history.notes as notes,
    job_history.number_of_payments as number_of_payments,
    job_history.other_rate_1 as other_rate_1,
    job_history.other_rate_2 as other_rate_2,
    job_history.other_rate_3 as other_rate_3,
    job_history.other_rate_4 as other_rate_4,
    job_history.pay_period_code as pay_period_code,
    job_history.percent_change as percent_change,
    job_history.period_pay_rate as period_pay_rate,
    job_history.piece_pay_rate as piece_pay_rate,
    job_history.project_code as project_code,
    job_history.reason_code as reason_code,
    job_history.salary_grade as salary_grade,
    job_history.salary_or_hourly as bln_is_salary,
    job_history.scheduled_annual_hours as scheduled_annual_hours,
    job_history.scheduled_full_time_equivalency as scheduled_full_time_equivalency,
    job_history.scheduled_work_hours as scheduled_work_hours,
    job_history.shift_code as shift_code,
    job_history.shift_group_code as shift_group_code,
    job_history.step_number as step_number,
    ...
    job_history.weekly_hours as weekly_hours,
    job_history.weekly_pay_rate as weekly_pay_rate
from job_history