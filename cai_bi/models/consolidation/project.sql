...
salesforce as (
    select
        md5(sf_project.id) as pk_project,
        'sfc' as src_sys_key,
        ...
        null as int_manager_id,
        sf_project.pse_region_c as intacct_region_id,
        ...
        cast(sf_project.intacct_record_no_c as string) as project_link_id,
        ...
        sf_project.id as system_id,
        null as term_key,
        null as qty_actual,
        null as amt_bac_awarded,
        null as amt_budget_at_completion,
        null as amt_cai_spent_1,
...
sage_intacct as (
    select 
        ...
        cast(recordno as string) as project_link_id,
        ...
        cast(recordno as string) as system_id,
...
psatools as (
    select 
        md5(id) as pk_project,
        'psa' as src_sys_key,
        current_timestamp as dts_created_at,
        'psatools' as created_by,
        current_timestamp as dts_updated_at,
        'psatools' as updated_by,
        current_timestamp as dts_eff_start,
        '9999-12-31' as dts_eff_end,
        true as bln_current,
        ...
        int_record_no as project_link_id,
        null as project_location_key,
