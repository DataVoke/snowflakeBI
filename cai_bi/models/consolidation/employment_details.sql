...
ukg as (
    select
        ...
        case when dts_eff_end ='9999-12-31' then true else false end as bln_current,
        employee_job_history.id as key,
        md5(employee_job_history.id) as hash_key,
        ...
        employment.employee_id as key_employee,
        md5(employment.employee_id) as hash_key_employee,
        employment.id as key_employment,
        md5(employment.id) as hash_key_employment,       
