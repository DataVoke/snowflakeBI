...
sage_intacct as (
    select
        ...
        -- si_expenseitem.megaentityid as key_entity,
        -- md5(si_expenseitem.megaentityid) as hash_key_entity,
        ...
        -- si_expenseitem.vendorkey as vendor_key,
