...
select
    ...
    task.po_amount_awarded_c as amt_po_awarded,
    ...
    task.original_proposal_budget_c as budget_original,
    task.cost_variance_c as cost_variance,
    ...
    task.pse_estimated_hours_c as hours_estimated,
    task.pse_estimated_hours_rollup_c as hours_estimated_rollup,
    task.original_proposal_hrs_or_units_c as hours_original,
    task.pse_actual_hours_c as hours_actual,
    task.pse_timecard_actual_hours_c as hours_timecard_actual,
    task.additional_hrs_or_units_c as hrs_or_units_additional,
    ...
    task.milestone_status_indirect_tvl_c as milestone_status_indirect_tvl,
    task.name as name,
    task.pse_percent_complete_tasks_c as percent_complete_tasks,
    case 
    ...
    end as rate_original,
    task.additional_rate_c as rate_additional,
